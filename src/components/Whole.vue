  ...
  <div>
    <div class="apollo-vehicle-search">
      <div class="apollo-vehicle-search-set">
        <button type="button" class="apollo-btn apollo-btn-default" :class="{'apollo-btn-disabled': dataCheckLen === 0}" @click="monitoring" :disabled="dataCheckLen===0">
          <span>{{this.language.top[0]}}</span>
        </button>
    ...
    <div>
      <table-view :tableData="intrudata" ref="tableSet" :method="method" :addser="addser" @addver="addver" @mag="mag"></table-view>
  ...
  export default {
    ...
    data () {
      return {
        ...
        lang: '',
        language: {},
        disableClass: 'apollo-btn-disabled',
        en: {
    ...
    methods: {
      getCarTotalInfoList () {
        this.$http.get('http://localhost:3000/getCarTotalInfoList?language=' + this.lang, {
          params: {
        ...
        if (car.length !== 0) {
          this.$http.post(this.addser.addurl, {carIdArr: car})
            .then((res) => {
              ...
              function time () {
                that.$refs.tableSet.checkList = []
                that.$refs.tableSet.removeCheck()
      ...
      pageOpt: function (data) {
        this.$refs.tableSet.checkList = []
        this.$refs.tableSet.removeCheck()
